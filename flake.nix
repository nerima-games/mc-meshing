{
  description = "mc-meshing: Pure chunk-data -> geometry-buffer conversion for the nerima-games Minecraft-clone rebuild: the three-valued opacity model, canonical face order, and greedy meshing.";
